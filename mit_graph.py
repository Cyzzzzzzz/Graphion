...
class MixVisionTransformer_Graph(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 with_cp=False):
        super(MixVisionTransformer_Graph, self).__init__(init_cfg=init_cfg)
        ...
        for i, num_layer in enumerate(num_layers):
            ...
            graph_stage = Sequential(*[
                GraphBlock(
                    in_channels=embed_dims_i,
                    patch_size=graph_patch_sizes[i]
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(MixVisionTransformer_Graph, self).init_weights()

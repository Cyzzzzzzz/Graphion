...
class ResNet_Graph(BaseBackbone):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        self.stem_maxpool = stem_maxpool
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            in_graph = Sequential(*[
                ...
                nn.BatchNorm2d(num_features=_in_channels // 2)
            ])
            ...
            out_graph = Sequential(*[
                ...
                nn.BatchNorm2d(num_features=_in_channels)
            ])
    ...
    def init_weights(self):
        super(ResNet_Graph, self).init_weights()
...
@BACKBONES.register_module()
class ResNetV1c_Graph(ResNet_Graph):
    """ResNetV1c backbone.
    ...
    def __init__(self, **kwargs):
        super(ResNetV1c_Graph, self).__init__(
